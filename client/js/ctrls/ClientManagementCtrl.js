...
define(['can/control', 'can/view/mustache', 'Auth', 'newClientCtrl', '$'], function(Ctrl, can, Auth, newClientCtrl) {
  var getClient, mergeCol, onLoadSuccess;
  ...
  getClient = function(pageNum, pageSize) {
    return $.getJSON(Auth.apiHost + 'mywms/client/page', {
      page: pageNum,
      rows: pageSize
    }, function(data) {
    ...
    init: function() {
      ...
      $('.easyui-pagination').pagination({
        ...
        onSelectPage: function(pageNum, pageSize) {
          return getClient(pageNum, pageSize);
        }
      });
      $('#clients').datagrid({
      ...
      return getClient(0, 10);
    },
    '#addClientBtn click': function() {
      console.log('click');
      return new newClientCtrl('#dialog', {});
    }
  });
});
